...
<%
   Student student = (Student)session.getAttribute("student1");
    if(student==null){// 页面访问控制
        out.print("<script>alert('您尚未登录，禁止操作！');location.href='login.jsp';</script>");
    }
    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <img src="/ReadstuServlet" class="layui-nav-img">
                        <cite><%=name%></cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a lay-href="infos.jsp">基本资料</a></dd>
                        <dd><a lay-href="updatepassword.jsp">修改密码</a></dd>
                        <hr>
                        <dd layadmin-event="logout" style="text-align: center;">
                            <a lay-href = "login.jsp">退出</a></dd>
                    </dl>
                </li>
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console" class="layui-this">
                                <a lay-href="data.jsp">学生整体趋势</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="stugrade.jsp">学生成绩表</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="student.jsp">学生基本信息表</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="selectCourse1.jsp">选课中心</a>
                            </dd>
                        </dl>
                    </li>
                    ...
                    <li data-name="set" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd class="layui-nav-itemed">
                                ...
                                <dl class="layui-nav-child">
                                    <dd><a lay-href="infos.jsp">基本资料</a></dd>
                                    <dd><a lay-href="updateStude.jsp">修改密码</a></dd>
                                </dl>
                            </dd>
                        </dl>
                    </li>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="data.jsp" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
